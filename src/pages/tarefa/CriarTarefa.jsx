        ...
        <CardContent sx={{
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="small" variant="contained" onClick={handleSalvar} color="success">Salvar</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button size="small" variant="outlined" onClick={handleClose} color="error" sx={{ ml: 1 }}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
